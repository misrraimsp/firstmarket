...
create table security_token (id bigint not null, edited_email varchar(255), expiry_date timestamp, security_event integer, token varchar(255), user_id bigint not null, primary key (id));
...
alter table security_token add constraint fk_userIdOnVerificationToken foreign key (user_id) references user(id);
