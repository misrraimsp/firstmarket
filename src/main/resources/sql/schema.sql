...
create table book (id bigint not null, description varchar(510), isbn varchar(255), language integer, pages integer, price decimal(11,2), stock integer, title varchar(255), year integer, category_id bigint, image_id bigint, publisher_id bigint, primary key (id));
...
create table user (id bigint not null, email varchar(255), completed boolean not null, suspended boolean not null, password varchar(255), cart_id bigint, profile_id bigint, primary key (id));
...
create table security_token (id bigint not null, edited_email varchar(255), expiry_date timestamp, security_event integer, token varchar(255), user_id bigint, primary key (id));
...
alter table user_deletion add constraint fk_userIdOnUserDeletion foreign key (user_id) references user(id);
alter table security_token add constraint fk_userIdOnSecurityToken foreign key (user_id) references user(id);
