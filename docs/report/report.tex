...
\begin{document}
    ...
    En esta sección se estudian los costes asociados al desarrollo de la aplicación web. Es necesario aclarar que, dado el carácter académico de la presente aplicación web, se trata de un estudio aproximativo, en el que a grandes rasgos se describen las principales líneas de recursos y sus costes.
    
    De una manera amplia, estos costes pueden ser agrupados en coste del factor humano y coste de los recursos materiales. Para analizar los primeros es necesario distinguir los diferentes roles profesionales implicados en la consecución de los objetivos. En este sentido, varios perfiles pueden ser identificados, a saber, la dirección del proyecto, encargada de la planificación y distribución de tareas, un analista/diseñador, encargado de recabar las necesidades y especificar las grandes directrices de la solución a adoptar, y un programador que las lleve a cabo.
    
    \begin{center}
    	\begin{tabular}{ | m{10em} | m{10em}| m{10em} | } 
    		\hline
    		Tarea & Perfil Profesional & Coste Horario \\ 
    		\hline
    		Dirección del Proyecto & B.I & \EUR{30} \\ 
    		\hline
    		Análisis y Diseño & C.I & \EUR{30} \\ 
    		\hline
    		Implementación & D.I & \EUR{30} \\ 
    		\hline
    	\end{tabular}
    \end{center}
