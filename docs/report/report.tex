...
\begin{document}
   ...
   \clearpage
    ...
    Tal como se explica en \cite{Kurose2016}, esta pregunta puede ser enfocada desde dos puntos de vista complementarios.
    ...
    Como ya ha comentado en \cite{Kurose2016}
    %Testar el software
