...
\begin{document}
	...
	En el listado \ref{list:filter_chain} se aprecia el mensaje de registro emitido durante el arranque de la aplicación en el que se detalla la cadena de filtros que Spring Security proporciona. Pues bien, en esencia, \textbf{Spring Security \emph{es} esta cadena de filtros concatenados antes del \emph{DispatcherServlet}}.
	\\
	
	\begin{lstlisting}[caption=Cadena de filtros creada por Spring Security, label=list:filter_chain]
	2020-07-18 14:42:11.159  INFO 6752 --- [main] o.s.s.web.DefaultSecurityFilterChain: 
	Creating filter chain: 
	any request, [
	o.s.s.w.access.channel.ChannelProcessingFilter@1805383, 
	o.s.s.w.context.request.async.WebAsyncManagerIntegrationFilter@786a3477, 
	o.s.s.w.context.SecurityContextPersistenceFilter@11e834ad, 
	o.s.s.w.header.HeaderWriterFilter@1187dc82, 
	o.s.s.w.csrf.CsrfFilter@505d2bac, 
	o.s.s.w.authentication.logout.LogoutFilter@6f07d414, 
	o.s.s.w.authentication.UsernamePasswordAuthenticationFilter@64fdcf99, 
	o.s.s.w.savedrequest.RequestCacheAwareFilter@25d911a, 
	o.s.s.w.servletapi.SecurityContextHolderAwareRequestFilter@76828577, 
	o.s.s.w.authentication.AnonymousAuthenticationFilter@286866cb, 
	o.s.s.w.session.SessionManagementFilter@18e4551, 
	o.s.s.w.access.ExceptionTranslationFilter@356b6b5d, 
	o.s.s.w.access.intercept.FilterSecurityInterceptor@7b7068d8
	]
	\end{lstlisting}
