...
\begin{document}
	...
	\begin{itemize}
		\item[-] \textbf{\emph{Reflected cross-site scripting}}. Esta vulnerabilidad, considerada de alto riesgo, fue encontrada durante el escáner OWASP top 10.
		...
		\item[-] \textbf{\emph{Potential DoS on TLS Client Renegotiation}}.
